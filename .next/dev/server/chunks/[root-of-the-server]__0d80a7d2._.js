...
"[project]/Downloads/aicareermentor/app/api/submit-quiz/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function callOllama(prompt) {
    ...
    try {
        ...
        try {
            ...
            throw new Error("Open-source AI service unavailable. Please ensure Ollama is running (http://localhost:11434) or configure Hugging Face API key.");
        }
    }
}
...
Génère mes recommandations de carrière personnalisées en JSON valide basé sur ces réponses.`;
        ...
        if (userId) {
            try {
                ...
                const { createClient } = await __turbopack_context__.A("[project]/Downloads/aicareermentor/lib/supabase/server.ts [app-route] (ecmascript, async loader)");
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$aicareermentor$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: errorMessage,
            aiResult: errorMessage.includes("Open-source AI service unavailable") ? "Please configure Ollama or Hugging Face to generate AI recommendations. See setup instructions in the README." : "Unable to generate recommendations. Please try again."
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0d80a7d2._.js.map